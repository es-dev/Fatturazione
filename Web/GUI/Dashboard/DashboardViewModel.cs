    ...
    public class DashboardViewModel: TemplateViewModel<DashboardDto, DashboardItem>
    {
        ...
        public override IQueryable<DashboardDto> QueryDashboards()
        {
            try
            {
                ...
                var dashboardSoci = new DashboardDto("Soci", "SOC", "Definisci i soci dello studio professionale eil tipo di carica ricoperta...", "Images.dashboard.socio.png", "", typeof(SocioView));
               
                dashboards.Add(dashboardFatturazioni);
                dashboards.Add(dashboardAccount);
                dashboards.Add(dashboardStudioProfessionale);
                dashboards.Add(dashboardSoci);
